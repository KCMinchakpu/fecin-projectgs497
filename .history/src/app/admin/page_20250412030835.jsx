...
const AdminPage = () => {
  ...
  useEffect(() => {
    setIsClient(true); // This will trigger after the component mounts
  }, []);
  ...
  // Render loading state during session fetch and initial mount
  if (status === 'loading' || !isClient) {
    return <p>Loading...</p>; // Show loading state until client-side logic is ready
  }
